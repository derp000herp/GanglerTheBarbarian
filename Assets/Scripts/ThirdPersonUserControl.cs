...
namespace MyAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (!m_LightAttack)
            {
                m_LightAttack = CrossPlatformInputManager.GetButtonDown("LightAttack");
            }
            if (!m_HeavyAttack)
            {
                m_HeavyAttack = CrossPlatformInputManager.GetButtonDown("HeavyAttack");
            }
        }
